...
namespace Saraff.Twain.DS.Capabilities {
    ...
    //ICAP_YNATIVERESOLUTION All MSG_GET* operations required for scanners
    [DataSourceCapability(TwCap.YNativeResolution, TwType.Fix32, SupportedOperations=TwQC.Get|TwQC.GetCurrent|TwQC.GetDefault, Get=TwOn.One)]
    internal sealed class YNativeResolutionDataSourceCapability:DeviceDataSourceCapability<float> {
        ...
        protected override float CoreValue {
            get {
                ...
                return _val!=0f?_val:this.DeviceProperties.YNativeResolution;
            }
            set {
