...
namespace Saraff.Twain.DS.Capabilities {
    ...
    [DataSourceCapability(TwCap.PhysicalWidth, TwType.Fix32, SupportedOperations=TwQC.Get|TwQC.GetCurrent|TwQC.GetDefault, Get=TwOn.One)]
    internal sealed class PhysicalWidthDataSourceCapability:DeviceDataSourceCapability<float> {
        ...
        protected override float CoreValue {
            get {
                ...
                return _val!=0f?_val:this.DeviceProperties.PhysicalWidth;
            }
            set {
